...
What numbers do the boxplots show? Some of these numbers we will explore in more detail in a [later tutorial](Summarizing.html). For now we will look at a brief explanation of each. The summary numbers can be broken down into three components. First the 'box' at the center of each boxplot:
